                      ...
                      echo'
                        <tr class="bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-900 text-gray-700 dark:text-gray-400">
                          ...
                          <td class="px-4 py-3 text-sm">
                            ...
                            <a href ="delete.php?Studentid='.$student['Studentid'].'" class="text-red-500" title="Delete this record" onClick="return confirm(\'Are you sure you want to delete this record?\');">Delete</a>
                          </td>
                        </tr>
                      ';  
                    endforeach;  
